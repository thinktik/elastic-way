...
class Ipv6Ctrl {
    ...
    OmozResponse<Map<String, Ipv6AddressGeo>> ipv4(@PathVariable("ipv6") String ipv6) {
        OmozResponse<Map<String, Ipv6AddressGeo>> response = new HttpResponse<>()
